...
class PostUploadComponent extends React.Component {
    handleUploadButon = () => {
        if (this.props.tempBoolean === true) {
            ...
            this.props.updateUploadButton(<GetUploadDataComponent handlePost = {this.props.handlePost}/>);
...
export default connect(mapStateToProps , mapDispatchToProps)(PostUploadComponent);