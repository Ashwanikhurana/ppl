...
class AddCategoryComponent extends React.Component {
    handleAddCategoryButton = () => {
        if (this.props.tempBoolean1 === true) {
            ...
            this.props.changeCategoryComponent(< UploadCategoryComponent handleCategory = {this.props.handleCategory}/>);
    ...
    render() {
        return (
            <div>
                <button className="rght_btn"  onClick = {this.handleAddCategoryButton}> <span className="rght_btn_icon"><img src="images/btn_icona.png" alt="up" /></span> <span className="btn_sep"><img src="images/btn_sep.png" alt="sep" /></span> <a>Add category</a> </button>
...
var mapDispatchToProps = (dispatch) => {
    return {
        ...
        changeTemp : data => {dispatch({type : "CHANGE_TEMP_BOOLEAN1" , payload : data})},
        changeCategoryComponent : data => {dispatch({type : "CHANGE_CATEGORY_BUTTON" , payload : data})}
    }
}
